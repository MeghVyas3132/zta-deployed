...
DATA_KEYWORDS: tuple[str, ...] = (
    # Academic
    "attendance", "grade", "gpa", "subject", "course", "timetable",
    "semester", "exam", "result", "class", "marks", "score",
    # Finance
    "fee", "payment", "budget", "revenue", "salary", "payroll",
    "invoice", "balance", "due", "paid",
    # HR
    "leave", "faculty", "employee", "payslip", "attrition", "staff",
    # Admissions
    "admission", "applicant", "enrolment", "enrollment", "application",
    # Department
    ...
    "show", "tell", "what is", "what's", "how many", "how much",
    "give me", "get", "list", "display", "my",
)
